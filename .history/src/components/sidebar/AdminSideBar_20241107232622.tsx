  ...
  return (
    <div className={`admin-sidebar-container ${isOpen ? 'open' : 'closed'}`}>
      <div className="admin-sidebar-content">
        ...
        <Link to="https://sandbox.vnpayment.vn/merchantv2/Transaction/PaymentSearch.htm?bankCode=&ordid=&fromdate=20-10-2024&todate=07-11-2024&tnxref=&payType=&trace=&status=&desc=&mcStatus=" className="admin-box">
          <FontAwesomeIcon icon={faBook} className="sidebar-icon" />
